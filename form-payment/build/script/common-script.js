...
!function (e, r) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? r(exports) : "function" == typeof define && define.amd ? define(["exports"], r) : r((e = e || self).VueMask = {});
}(void 0, function (e) {
  "use strict";
  ...
  function a() {
    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : i,
        r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "_";
    if (!u(e)) throw new Error("Text-mask:convertMaskToPlaceholder; The mask property must be an array.");
  ...
  function l() {
    ...
    if (!u(t)) {
      if ("function" !== r(t)) throw new Error("Text-mask:conformToMask; The mask property must be an array.");
      t = c(t = t(e, n)).maskWithoutCaretTraps;
    }
    ...
    if (!0 === g && !x) {
      ...
      e = e.slice(0, E) + V + e.slice(E, b);
    }

    for (var M = e.split("").map(function (e, r) {
      return {
        "char": e,
        isNew: r >= E && r < P
      };
    ...
    e: for (var N = 0; N < k; N++) {
      ...
      if (D === v) {
        if (M.length > 0) for (; M.length > 0;) {
          ...
          if (t[N].test(z)) {
            if (!0 === g && !1 !== B && "" !== s && !1 !== i && x) {
              for (var H = M.length, I = null, J = 0; J < H; J++) {
                var L = M[J];
                if (L["char"] !== v && !1 === L.isNew) break;
    ...
    if (m && !1 === x) {
      for (var W = null, $ = 0; $ < R.length; $++) {
        h[$] === v && (W = $);
      }

      R = null !== W ? R.substr(0, W + 1) : "";
    }
  ...
  var s = {
    ...
    X: /./
      ...
      v = function v(e) {
    return r = e.toString().replace(/.(\/)[gmiyus]{0,6}$/, function (e) {
      return e.replace("/", "?/");
    }), t = r.lastIndexOf("/"), new RegExp(r.slice(1, t), r.slice(t + 1));
    var r, t;
  },
      d = function d(e) {
  ...
  var O = function () {
    ...
    return {
      partiallyUpdate: function partiallyUpdate(r, n) {
        e.set(r, o(o({}, t(r)), n));
      },
  ...
  function j(e, r, t) {
    ...
    n = Array.isArray(r) ? function (e) {
      ...
      return h(t, r);
    }(r, t) : m(r) ? r : b(r) && r.length > 0 ? y(r, t) : r, O.partiallyUpdate(e, {
      mask: n
    });
  }
  ...
  function x(e) {
    ...
    return null === e || Array.isArray(e) || "object" !== r(e) ? n : Object.keys(e).reduce(function (r, n) {
      var i = e[n];
      return null === i || i instanceof RegExp ? o(o({}, r), {}, t({}, n, i)) : r;
    }, n);
  }
  ...
  var V = P(),
    ...
    return l(e, y(r), {
      ...
      M = function M(e) {
    var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
    e.directive("mask", P(r)), e.filter("VMask", A);
  };

  e.VueMaskDirective = V, e.VueMaskFilter = A, e.VueMaskPlugin = M, e["default"] = M, Object.defineProperty(e, "__esModule", {
    value: !0
  });
});
...
Vue.component('help', {
  ...
  computed: {
    getStep: function getStep() {
      return !this.card ? 'step0' : this.card && !this.confirmPhone && !this.confirmSms ? 'step1' : this.card && this.confirmPhone ? 'step2' : 'step3';
    }
  }
});
var app = new Vue({
  ...
  filters: {
    currency: function currency(value, symbol, count) {
  ...
  directives: {
    ...
    checkdate: {
      update: function update(el, bind) {
        var value = el.value;
        var date = new Date();
        var year = +"".concat(date.getFullYear()).slice(2);
        var month = date.getMonth() + 1;
        var cardDate = el.value.split('/');
        var cardYear = +cardDate[1];
        var cardMonth = +cardDate[0];
